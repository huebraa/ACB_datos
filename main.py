...
# TAB 7: Scouting Report (ejemplo)
tabs[6].subheader("Scouting Report - Ejemplo")
tabs[6].write("Aquí podrías generar análisis más detallados o reportes personalizados.")
